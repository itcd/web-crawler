...
scrapy crawl count -a url=%URL1% -o ~temp.json
scrapy crawl fetch -o ~temp.json
copy /y ~temp.json GOOG_unordered.json
del /f ~temp.json

scrapy crawl count -a url=%URL2% -o ~temp.json
scrapy crawl fetch -o ~temp.json
copy /y ~temp.json AMZN_unordered.json
del /f ~temp.json

scrapy crawl count -a url=%URL3% -o ~temp.json
scrapy crawl fetch -o ~temp.json
copy /y ~temp.json FB_unordered.json
del /f ~temp.json

scrapy crawl count -a url=%URL4% -o ~temp.json
scrapy crawl fetch -o ~temp.json
copy /y ~temp.json MSFT_unordered.json
del /f ~temp.json
